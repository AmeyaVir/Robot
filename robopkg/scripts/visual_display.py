...
def main_fcn():
	...
	pub3 = rospy.Publisher('arm_status',String,queue_size = 100)
	...
	joint_state_send.name = ['base_rot_to_link_1','link_1_to_link_2' ,'link_2_to_link_3']
	...
	while not rospy.is_shutdown():
		...
		joint_state_send.position = [-angle['s2'],+angle['s2']+angle['s3'],-angle['s3']]
