...
def raiseError():
	...
	print 'ERROR: 1: Input nothing after report_anlges_node.py (example: rosrun robopkg report_angles_node.py)'
	print 'ERROR: 2: Input how many times to print (example: rosrun robopkg report_angles_node.py 12)'
	print 'ERROR: 3: Input times and time_sec between each times (example: rosrun robopkg report_angles_node.py 12 2)'
